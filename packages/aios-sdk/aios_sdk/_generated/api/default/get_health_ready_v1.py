...
from ...models.get_health_ready_v1_response_get_health_ready_v1 import (
...
) -> GetHealthReadyV1ResponseGetHealthReadyV1 | None:
    if response.status_code == 200:
        response_200 = GetHealthReadyV1ResponseGetHealthReadyV1.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetHealthReadyV1ResponseGetHealthReadyV1]:
    return Response(
